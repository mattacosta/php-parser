  ...
  describe('tokens', function() {
    ...
    describe('comments', function() {
      let tests = [
        ...
        new LexerTestArgs('<?php # line comment', 'single line comment using # syntax', [TokenKind.OpenTag, TokenKind.Whitespace, TokenKind.SingleLineComment], [], false),
        new LexerTestArgs('<?php // comment\n ', 'single line comment with LF', [TokenKind.OpenTag, TokenKind.Whitespace, TokenKind.SingleLineComment, TokenKind.Whitespace], [], false),
        new LexerTestArgs('<?php // comment\r\n ', 'single line comment with CRLF', [TokenKind.OpenTag, TokenKind.Whitespace, TokenKind.SingleLineComment, TokenKind.Whitespace], [], false),
