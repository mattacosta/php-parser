  ...
  describe('tokens', function() {
    ...
    describe('numbers', function() {
      ...
      //new LexerTestArgs('<?php 0b11111111111111111111111111111111', 'bin max int overflow (32-bit)', [TokenKind.DNumber]),
        ...
        new LexerTestArgs('<?php 1234e5', 'integer with exponent', [TokenKind.LNumber], ['1234e5']),
        new LexerTestArgs('<?php 1234E5', 'integer with exponent (uppercase)', [TokenKind.LNumber], ['1234E5']),
        new LexerTestArgs('<?php 123e+4', 'integer with exponent and positive sign', [TokenKind.LNumber], ['123e+4']),
        new LexerTestArgs('<?php 123e-4', 'integer with exponent and negative sign', [TokenKind.LNumber], ['123e-4']),
    ...
    describe('type casts', function() {
      let tests = [
        ...
        new LexerTestArgs('<?php (integer)', 'to integer (integer)', [TokenKind.IntCast]),
        new LexerTestArgs('<?php (double)', 'to double (double)', [TokenKind.DoubleCast]),
        new LexerTestArgs('<?php (float)', 'to double (float)', [TokenKind.DoubleCast]),
        new LexerTestArgs('<?php (real)', 'to double (real)', [TokenKind.DoubleCast]),
        new LexerTestArgs('<?php (string)', 'to string (string)', [TokenKind.StringCast]),
        new LexerTestArgs('<?php (binary)', 'to string (binary)', [TokenKind.StringCast]),
        ...
        new LexerTestArgs('<?php (boolean)', 'to boolean (boolean)', [TokenKind.BoolCast]),
